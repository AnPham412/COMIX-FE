...
import SearchNotFound from "../layouts/Navbars/SearchNotFound";
import {
  ListHead,
  ListToolbar,
  MoreMenu,
} from "../sections/Main/viewed";
//app
...
export default function Viewed() {
  ...
  const filteredArs = applySortFilter(articles, getComparator(order, orderBy), filterName);
